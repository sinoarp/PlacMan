const cid = document.getElementById("company-cid").value;
...
editProfBtn.addEventListener("click", (e) => {
  ...
  fetch("/company/edit/" + cid)
    ...
    .then((data) => {
      ...
      document.getElementById("companyCategory").value = data.category;
      document.getElementById("companyOffer").value = data.estimateOffer;
...
//           rowCell3.innerHTML = report.companies[i].averageOffer;
//           rowCell4.innerHTML = report.companies[i].maxOffer;
...
//       fetch("/teacher/place/" + student.roll)
//         .then((res) => res.json())
//         .then((data) => {
//           console.log(data);
//           alert(data.message);
